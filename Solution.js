 ...
 * @return {number}
 */
function createMinValueWithoutLeadingZerosAndGreaterThanZero(input, numberOfDigits) {
 ...
 * @return {number}
 */
function  createMaxValue(input, numberOfDigits) {
    let maxValue = 0;
    let digitToReplace = Util.NOT_FOUND;
    let extractorForLeftmostValue = Math.pow(10, numberOfDigits - 1);
